...
Test generated for /iam/v2/api-keys/{id}_delete for http method type DELETE in rest-assured framework

RoostTestHash=34f89cd3aa
...
public class iamV2ApikeysIdDeleteTest {
    ...
    public void setUp() {
      ...
      envList = dataloader.load("src/test/java/org/web3j/sample/RoostTest/iam_v2_api-keys_idDeleteTest.csv", envVarsList);
    }

  
    @Test  
    public void iamV2ApikeysIdDelete_Test() throws JSONException {
        this.setUp();
        ...
        for (Map<String, String> testData : envList) {
          RestAssured.baseURI = (testData.get("BASE_URL") != null && !testData.get("BASE_URL").isEmpty()) ? testData.get("BASE_URL"): "https://api.confluent.cloud";  
              ...
              System.out.printf("Test Case %d: iamV2ApikeysIdDelete_Test \n", testNumber++);
              System.out.println("Request: DELETE /iam/v2/api-keys/{id}");
      ...
      List<Integer> expectedStatusCodes = Arrays.asList(204,400,401,403,404,429,500);
      ...
      switch(Integer.toString(responseObj.statusCode()).charAt(0)){
              ...
              if (contentType.contains("application/xml") || contentType.contains("text/xml")) {
                ...
                if(stringifiedStatusCode == "204"){					System.out.println("Description: An API Key is being deleted.");
				}
