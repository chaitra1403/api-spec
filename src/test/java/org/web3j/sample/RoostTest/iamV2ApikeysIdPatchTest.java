...
Test generated for /iam/v2/api-keys/{id}_patch for http method type PATCH in rest-assured framework

RoostTestHash=ee31d425d4
...
public class iamV2ApikeysIdPatchTest {
    ...
    public void setUp() {
      ...
      envList = dataloader.load("src/test/java/org/web3j/sample/RoostTest/iam_v2_api-keys_idPatchTest.csv", envVarsList);
    }

  
    @Test  
    public void iamV2ApikeysIdPatch_Test() throws JSONException {
        this.setUp();
        ...
        for (Map<String, String> testData : envList) {
          RestAssured.baseURI = (testData.get("BASE_URL") != null && !testData.get("BASE_URL").isEmpty()) ? testData.get("BASE_URL"): "https://api.confluent.cloud";  
				...
				.body("{\n"+
					"  \"api_version\": \"" + (testData.get("api_version") != null ? testData.get("api_version") : "") + "\",\n" +
					"  \"kind\": \"" + (testData.get("kind") != null ? testData.get("kind") : "") + "\",\n" +
					"  \"id\": \"" + (testData.get("id") != null ? testData.get("id") : "") + "\",\n" +
					"  \"metadata\": \"" + (testData.get("metadata") != null ? testData.get("metadata") : "") + "\",\n" +
					"  \"spec\": \"" + (testData.get("spec") != null ? testData.get("spec") : "") + "\n" +
 				"}")
              ...
              System.out.printf("Test Case %d: iamV2ApikeysIdPatch_Test \n", testNumber++);
              System.out.println("Request: PATCH /iam/v2/api-keys/{id}");
      ...
      List<Integer> expectedStatusCodes = Arrays.asList(200,400,401,402,403,404,422,429,500);
