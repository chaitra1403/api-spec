...
public class userCreateWithListPostTest {
    ...
    public void setUp() {
      ...
      String[] envVarsList = {""};
      envList = dataloader.load("src/test/java/org/web3j/sample/RoostTest/user_createWithListPostTest.csv", envVarsList);
    }
...
")
              ...
              if (testData.get("statusCode") != null) {
                MatcherAssert.assertThat(responseObj.statusCode(),
                 ...
                 List<Integer> expectedStatusCodes = Arrays.asList(200,default);
