...
public class Application {
	...
	private void run() throws Exception {
		...
		Web3j web3j = Web3j.build(new HttpService("https://rinkeby.infura.io/<your token>")); // FIXME:
																								// Enter
																								// your
																								// Infura
																								// token
		...
		TransactionReceipt transferReceipt = Transfer
			.sendFunds(web3j, credentials, "0x19e03255f667bdfd50a32722df860b1eeaf4d635", // you
																							// can
																							// put
																							// any
																							// address
